...
As the target distribution ensures that we sample values of $\theta$ where the posterior has a positive likelihood, approximation of the marginal likelihoods will be more stable and efficient.
...
We apply our methods to the dataset introduced @vanterve2023 where cfDNA and buffy coat were sequenced for patients with metastatic colorectal cancer.
